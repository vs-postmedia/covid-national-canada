...
function rowTemplate(d) {
  ...
  var newToday = parseInt(d.numtoday) > 0 ? d.numtoday : 0;
  var deathsToday = parseInt(d.deathstoday) > 0 ? d.deathstoday : 0;
  return "\n\t\t<tr>\n\t\t\t<td class=\"province\">".concat(name, "</td>\n\t\t\t<td class=\"cases-million weight-").concat(activePerMilRange, "\">\n\t\t\t\t<p class=\"total-num\">").concat(helper_functions.numberWithCommas(d.active_cases_per_million), "</p>\n\t\t\t</td>\n\t\t\t<td class=\"active weight-").concat(activeRange, "\">\n\t\t\t\t<p class=\"total-num\">").concat(helper_functions.numberWithCommas(d.active_cases), "</p>\n\t\t\t\t<p>").concat(newToday, " new</p>\n\t\t\t</td>\n\t\t\t<td class=\"deaths weight-").concat(deathsRange, "\">\n\t\t\t\t<p class=\"total-num\">").concat(helper_functions.numberWithCommas(d.numdeaths), "</p>\n\t\t\t\t<p>").concat(deathsToday, " new</p>\n\t\t\t</td>\n\t\t\t<td class=\"recovered weight-").concat(recoveredRange, "\">\n\t\t\t\t<p class=\"total-num\">").concat(helper_functions.numberWithCommas(d.numrecover), "</p>\n\t\t\t</td>\n\t\t</tr>\n\t");
}
...
var dataUrl = 'https://vs-postmedia-data.sfo2.digitaloceanspaces.com/covid-healthcanada-data.json';
